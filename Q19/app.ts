...
console.log(`Initial number of guests: ${guests.length}`);
...
console.log(`Number of guests after replacement: ${guests.length}`);
...
console.log(`Number of guests after adding more: ${guests.length}`);
...
console.log(`Number of guests remaining: ${guests.length}`);
...
console.log(`Final number of guests: ${guests.length}`);